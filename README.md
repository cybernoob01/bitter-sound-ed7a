...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-sound-ed7a
```

A live public deployment of this template is available at [https://bitter-sound-ed7a.templates.workers.dev](https://bitter-sound-ed7a.templates.workers.dev)
